...
public class GameRun {
    ...
    public static void main (String[] args) {
        ...
        items[0] = new Objects("Basic Sword", 5,0);
        items[1] = new Objects("Iron Sword", 15, 0.0);
        items[2] = new Objects("Elucidator",25, 0.0);
        items[3] = new Objects("Excalibur", 50, 0.0);
        items[4] = new Objects ("Leather Armor", 0, 5);
        items[5] = new Objects("Hero's Tunic", 0, 10  );
        items[6] = new Objects ("Adamantium Armor", 0, 20);
